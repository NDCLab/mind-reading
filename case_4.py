...
df_accr.to_csv(
    output_path + f'case_4_accuracy_{time_window1}-{time_window2}.csv')

df_preci.to_csv(
    output_path + f'case_4_precision_{time_window1}-{time_window2}.csv')

df_cross_val.to_csv(
    output_path + f'case_4_cv_acc_{time_window1}-{time_window2}.csv')
